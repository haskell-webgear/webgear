...
headerHandler :: forall name val e p h req.
...
--
optionalHeader :: forall name val h req.
...
--
lenientHeader :: forall name val h req.
...
--
optionalLenientHeader :: forall name val h req.
...
--
setHeader :: forall name val h res. Set h (Header Required Strict name val) Response
...
--
setOptionalHeader :: forall name val h res. Set h (Header Optional Strict name val) Response

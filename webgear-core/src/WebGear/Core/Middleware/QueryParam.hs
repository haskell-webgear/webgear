...
queryParamHandler :: forall name val e p h req.
...
--
queryParam :: (Get h (QueryParam Required Strict name val) Request, ArrowChoice h)
...
--
optionalQueryParam :: (Get h (QueryParam Optional Strict name val) Request, ArrowChoice h)
...
--
lenientQueryParam :: (Get h (QueryParam Required Lenient name val) Request, ArrowChoice h)
...
optionalLenientQueryParam :: (Get h (QueryParam Optional Lenient name val) Request, ArrowChoice h)

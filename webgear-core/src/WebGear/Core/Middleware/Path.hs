...
-- > path @"a/b/c" handler
--
path :: (Get h Path Request, ArrowChoice h, ArrowError RouteMismatch h)
     => Text
...
pathEnd :: (Get h PathEnd Request, ArrowChoice h, ArrowError RouteMismatch h)
